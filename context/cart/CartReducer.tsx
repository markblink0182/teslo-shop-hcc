...
type CartActionType = 
    | { type: '[Cart] - Load Cart from cookies | storage', payload: ICardProduct[]}
    | { type: '[Cart] - Update products in car', payload: ICardProduct[]  }
    ...
    | { 
        type: '[Cart] - [Cart] - Update order summary', 
        payload: {
...
export const CartReducer = (state: CartState, action: CartActionType): CartState=>{
    switch (action.type) {
        ...
        case '[Cart] - [Cart] - Update order summary':
            return {
                ...state,
                ...action.payload
            }
